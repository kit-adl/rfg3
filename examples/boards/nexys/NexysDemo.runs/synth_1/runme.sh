...
HD_PWD='E:/Common/Projects/git/odfi-manager/install/rfg3/examples/boards/nexys/NexysDemo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_demo_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source nexys_demo_top.tcl
