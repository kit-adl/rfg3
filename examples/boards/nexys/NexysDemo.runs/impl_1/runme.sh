...
HD_PWD='E:/Common/Projects/git/odfi-manager/install/rfg3/examples/boards/nexys/NexysDemo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_demo_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source nexys_demo_top.tcl -notrace
