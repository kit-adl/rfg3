...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS12 } [get_ports { res_n }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
#create_clock -add -name prog_clko -period 16.33  [get_ports { prog_clko }]; 
