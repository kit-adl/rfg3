...
import kit.ipe.adl.rfg3.model.VerilogLongValue
...
class BaseTypesTest extends FeatureSpec with ShouldMatchers with GivenWhenThen {
  ...
  feature("Verilog Value") {
    ...
    scenario("Hex Value") {
      ...
      assertResult("abcd")(java.lang.Long.toHexString(buffer.dataFromString("16'hABCD")))
      ...
      assertResult("abcd")(java.lang.Long.toHexString(buffer.data))
    }
